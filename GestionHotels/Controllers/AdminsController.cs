...
namespace GestionHotels.Controllers
{
    public class AdminsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "idAdm,nom,prenom,email,cin,tel,mdp")] Admins admins)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "idAdm,nom,prenom,email,cin,tel,mdp")] Admins admins)
        {
            if (ModelState.IsValid)
            {
